...
LIBINTL_LITE_API const char* bindtextdomain(const char* domain, const char* dirname);

LIBINTL_LITE_API const char* bind_textdomain_codeset(const char* domain, const char* dirname);
...
/**
 * Works like the gettext() function
 */
