...
. src/config_pcre2.h         build-time configuration options for the library
...
Versions of config_pcre2.h and pcre2.h are distributed in the src directory of PCRE2
tarballs under the names config_pcre2.h.generic and pcre2.h.generic. These are
...
(A) Source files for the PCRE2 library functions and their headers are found in
  ...
  src/config_pcre2.h.in          template for config_pcre2.h, when built by "configure"
...
(E) Auxiliary files for building PCRE2 "by hand"
  ...
  src/config_pcre2.h.generic    ) a version of config_pcre2.h for use in non-"configure"
                          )   environments
