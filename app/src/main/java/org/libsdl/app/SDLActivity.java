...
/**
    SDL Activity
     ...
     -- Modification III For Tux Paint
         Loading libraries is handled in the Tux Paint side.
     -- Modification IV For Tux Paint
         Hardcode library to "libtuxpaint.so"
     -- Modification V for Tux Paint
...
*/
    ...
    public void setOrientationBis(int w, int h, boolean resizable, String hint)
    {
	    ...
	    /* Tux Paint FIXME: Reversed orientation in SDL update to 2.28.5
	       Should take a look at config and adjust as needed */
